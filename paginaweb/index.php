...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.php" class="logo">Digital<em> Plug</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="index.php">inicio</a></li>
                            <li class="scroll-to-section"><a href="contact.php">Contacto</a></li>
                          <li class="scroll-to-section"><a href="#features">somos digital plug</a></li>
                          <li class="scroll-to-section"><a href="#features">portafolio</a></li>
    ...
    <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="assets/images/videodigital.mp4" type="video/mp4" />
        </video>

        <div class="video-overlay header-text">
            <div class="caption">
                <h6>Soluciones</h6>
                <h2>a traves de <em>Biometria</em></h2>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        <h2>digital<em>Plug</em></h2>
                        <img src="assets/images/line-dec.png" alt="waves">
                        <p style="font-size: 20px">Empresa Pereirana, enfocada en servicios de identificación biométrica
                            para el control de ingresos de personas a diferentes tipos de establecimientos</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <h2>.<em>nuestra</em> ,filo<em>sofia</em>!</h2>
                        <p>Empresa en la que los servicios y productos que ofrecen todos ganan: proveedores, empleados,
                            clientes, socios.
                            Productos y servicios de excelente calidad.
                            Mejoramiento continuo, en busca de la innovación, excelente ética de negocios</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; 2022 DigitaPlug

                        <a rel="nofollow" href="https://templatemo.com" class="tm-text-link" target="_parent"></a><br>

                        <a rel="nofollow" href="https://themewagon.com" class="tm-text-link" target="_blank"></a>
